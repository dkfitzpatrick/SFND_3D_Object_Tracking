...
medcorr,_ = pearsonr(xmin, medttccam)
avgcorr,_ = pearsonr(xmin, avgttccam)
...
l1,=ax1.plot(rd.time, rd.ttcCamera)
l2,=ax1.plot(rd.time, rd.medTtcCamera)
ax1.legend([l1,l2], ["avg camera distance", "median camera distance"])
